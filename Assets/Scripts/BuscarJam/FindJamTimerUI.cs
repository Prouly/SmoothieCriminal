...
public class FindJamTimerUI : MonoBehaviour
{
    ...
    [SerializeField] private FindJamLogic logicaJuego; // Arrastrar el manager de la escena
    #endregion
    ...
    void Start()
    {
        ...
        if (logicaJuego == null)
        {
            logicaJuego = FindAnyObjectByType<FindJamLogic>();
        }
